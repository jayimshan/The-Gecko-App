...
class Pez(QObject):
	...
	store = 'https://us.pez.com/'
	base_url = 'https://us.pez.com'
	url_products = 'https://us.pez.com/products.json'
	url_product = 'https://us.pez.com/products/'
	url_add_js = 'https://us.pez.com/cart/add.js'
	url_cart = 'https://us.pez.com/cart/'
	url_shipping_rates = 'https://us.pez.com/cart/shipping_rates.json'
	url_payment_gateway_endpoint = 'https://deposit.us.shopifycs.com/sessions'
	url_start_checkout = 'https://us.pez.com/checkout'
	url_wallets = 'https://us.pez.com/10522158/digital_wallets/dialog'
	payment_gateway = 97865921

	capture_folder = 'store_pez_test'

	headers = {
		'authority': 'us.pez.com',
		'method': 'GET',
		'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
		'accept-encoding': 'gzip, deflate, br',
		'accept-language': 'en-US,en;q=0.9,ko-KR;q=0.8,ko;q=0.7,pt;q=0.6',
		'origin': 'https://us.pez.com',
		'referer': 'https://us.pez.com/',
