...
class Limitedrun(QObject):
	...
	store = 'https://limitedrungames.com/'
	base_url = 'https://limitedrungames.com'
	url_products = 'https://limitedrungames.com/products.json'
	url_product = 'https://limitedrungames.com/products/'
	url_add_js = 'https://limitedrungames.com/cart/add.js'
	url_cart = 'https://limitedrungames.com/cart/'
	url_shipping_rates = 'https://limitedrungames.com/cart/shipping_rates.json'
	url_payment_gateway_endpoint = 'https://deposit.us.shopifycs.com/sessions'
	url_start_checkout = 'https://limitedrungames.com/checkout'
	url_wallets = 'https://limitedrungames.com/10522158/digital_wallets/dialog'
	payment_gateway = 22955523

	capture_folder = 'store_limitedrun_test'

	headers = {
		'authority': 'limitedrungames.com',
		'method': 'GET',
		'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
		'accept-encoding': 'gzip, deflate, br',
		'accept-language': 'en-US,en;q=0.9,ko-KR;q=0.8,ko;q=0.7,pt;q=0.6',
		'origin': 'https://limitedrungames.com',
		'referer': 'https://limitedrungames.com/',
	...
	def submit_payment(self, proxy=None):
		...
		vault_phone = '+1{}'.format(self.profile.phone)
		print('    [VAULT PHONE]: {}'.format(vault_phone))
		...
		if self.profile.same_as_shipping == QtCore.Qt.Checked:
			...
			payload = {
				...
				'checkout[vault_phone]': vault_phone,
